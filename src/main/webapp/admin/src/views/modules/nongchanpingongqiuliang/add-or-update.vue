    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="产品分类" prop="chanpinfenlei">
          <el-select v-model="ruleForm.chanpinfenlei" placeholder="请选择产品分类">
            <el-option
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.chanpintupian" label="产品图片" prop="chanpintupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.chanpintupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="供求量" prop="gongqiuliang">
          <el-input v-model="ruleForm.gongqiuliang" 
              placeholder="供求量" clearable  :readonly="ro.gongqiuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="供求量" prop="gongqiuliang">
              <el-input v-model="ruleForm.gongqiuliang" 
                placeholder="供求量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="需求量" prop="xuqiuliang">
          <el-input v-model="ruleForm.xuqiuliang" 
              placeholder="需求量" clearable  :readonly="ro.xuqiuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="需求量" prop="xuqiuliang">
              <el-input v-model="ruleForm.xuqiuliang" 
                placeholder="需求量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shijian = true;
          ...
          if(o=='gongqiuliang'){
            this.ruleForm.gongqiuliang = obj[o];
	    this.ro.gongqiuliang = true;
            continue;
          }
          if(o=='xuqiuliang'){
            this.ruleForm.xuqiuliang = obj[o];
	    this.ro.xuqiuliang = true;
            continue;
          }
          if(o=='xiangqing'){
    ...
    info(id) {
      this.$http({
        url: `nongchanpingongqiuliang/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssm5ws18/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `nongchanpingongqiuliang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.nongchanpingongqiuliangCrossAddOrUpdateFlag = false;
                  this.parent.search();
