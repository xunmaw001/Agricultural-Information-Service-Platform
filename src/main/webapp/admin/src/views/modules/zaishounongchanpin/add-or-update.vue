<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="种植账号" prop="zhongzhizhanghao">
          <el-input v-model="ruleForm.zhongzhizhanghao" 
              placeholder="种植账号" clearable  :readonly="ro.zhongzhizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="种植账号" prop="zhongzhizhanghao">
              <el-input v-model="ruleForm.zhongzhizhanghao" 
                placeholder="种植账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="种植姓名" prop="zhongzhixingming">
          <el-input v-model="ruleForm.zhongzhixingming" 
              placeholder="种植姓名" clearable  :readonly="ro.zhongzhixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="种植姓名" prop="zhongzhixingming">
              <el-input v-model="ruleForm.zhongzhixingming" 
                placeholder="种植姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="介绍" prop="jieshao">
                <el-input
...
export default {
  data() {
	...
	jieshao : false,
	shengchanriqi : false,
	zhongzhizhanghao : false,
	zhongzhixingming : false,
	thumbsupnum : false,
	crazilynum : false,
	price : false,
	userid : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shengchanriqi = true;
          ...
          if(o=='zhongzhizhanghao'){
            this.ruleForm.zhongzhizhanghao = obj[o];
	    this.ro.zhongzhizhanghao = true;
            continue;
          }
          if(o=='zhongzhixingming'){
            this.ruleForm.zhongzhixingming = obj[o];
	    this.ro.zhongzhixingming = true;
            continue;
          }
          if(o=='thumbsupnum'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.zhongzhizhanghao!=''&&json.zhongzhizhanghao){
              		this.ruleForm.zhongzhizhanghao = json.zhongzhizhanghao
		}
		if(json.zhongzhixingming!=''&&json.zhongzhixingming){
              		this.ruleForm.zhongzhixingming = json.zhongzhixingming
		}
        } else {
    ...
    info(id) {
      this.$http({
        url: `zaishounongchanpin/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zaishounongchanpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zaishounongchanpinCrossAddOrUpdateFlag = false;
                  this.parent.search();
