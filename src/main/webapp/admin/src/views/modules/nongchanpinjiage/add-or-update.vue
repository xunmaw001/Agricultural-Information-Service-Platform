<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="日期" prop="riqi">
          <el-input v-model="ruleForm.riqi" 
              placeholder="日期" clearable  :readonly="ro.riqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="日期" prop="riqi">
              <el-input v-model="ruleForm.riqi" 
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `nongchanpinjiage/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.nongchanpinjiageCrossAddOrUpdateFlag = false;
                  this.parent.search();
