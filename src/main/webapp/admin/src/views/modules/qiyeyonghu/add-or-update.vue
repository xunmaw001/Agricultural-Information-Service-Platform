<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="企业姓名" prop="qiyexingming">
          <el-input v-model="ruleForm.qiyexingming" 
              placeholder="企业姓名" clearable  :readonly="ro.qiyexingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="企业姓名" prop="qiyexingming">
              <el-input v-model="ruleForm.qiyexingming" 
                placeholder="企业姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	money : false,
      ...
      rules: {
          ...
          qiyexingming: [
                { required: true, message: '企业姓名不能为空', trigger: 'blur' },
          ],
          xingbie: [
          ],
          shouji: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.mima = true;
          ...
          if(o=='qiyexingming'){
            this.ruleForm.qiyexingming = obj[o];
	    this.ro.qiyexingming = true;
            continue;
          }
          if(o=='xingbie'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qiyeyonghu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qiyeyonghuCrossAddOrUpdateFlag = false;
                  this.parent.search();
